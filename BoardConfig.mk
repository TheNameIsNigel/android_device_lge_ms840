...
TARGET_BOOTLOADER_BOARD_NAME := ms840
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 0x006A4C80
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 0x006A4C80
...
#TARGET_KERNEL_CONFIG := cayman_mpcs_us-perf_defconfig
